...
class RaceLinkUIMixin:
    ...
    def register_settings(self):
        ...
        self._rhapi.ui.register_panel("rl_settings", "RaceLink Plugin", "settings")
    ...
    def register_quickset_ui(self):
        ...
        self._rhapi.ui.register_panel("rl_quickset", "RaceLink Quickset", "run")
        self._rhapi.fields.register_option(
            UIField("rl_quickset_group", "Node Group", UIFieldType.SELECT, options=self.uiGroupList, value=self.uiGroupList[0].value),
            "rl_quickset",
        )
        self._rhapi.fields.register_option(
                    ...
                    def _build_fields(mode):
                        ...
                        for var in vars_list:
                            ...
                            if select_options:
                                ...
                                continue
                            fields.append(
                                UIField(f"rl_special_{fn_key}_{var}", label, UIFieldType.BASIC_INT, value=default_val)
                            )
                        return fields
    ...
    # RL Data Exporter data collector function
    def rl_config_json_output(self, rhapi=None):
        ...
        payload["help/rl_groups/static_group"] = [
    ...
    # RL Data Importer function: write imported data to DB
